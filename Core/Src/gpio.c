...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(CTRL_SD_GPIO_Port, CTRL_SD_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(OLED_GND_GPIO_Port, OLED_GND_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, PWM_UL_Pin|PWM_VL_Pin|PWM_WL_Pin, GPIO_PIN_RESET);
  ...
  HAL_GPIO_Init(OLED_GND_GPIO_Port, &GPIO_InitStruct);
